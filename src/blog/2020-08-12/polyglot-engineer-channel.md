---
layout: post
title: "Polyglot Engineer Channel"
description: "Announcing the launch of the Polyglot Engineer Channel"
category: 
date: 2020-08-12
cover_image: "./polyglotengineerchannel.jpg"
---

I have recently started doing a VLOG, or video log on Polyglot programming. I am calling the channel the [Polyglot Engineer](https://polyglotengineer.com/) Channel. You can see the video content [here on youtube](https://www.youtube.com/channel/UC1TglgvYxS354qj7ZlmoUcA).

The first series of videos I am doing is on [Objective-C](https://en.wikipedia.org/wiki/Objective-C). Objective-C is a general purpose dynamically typed object oriented language based on C.

The language started out of a company that went on to become Stepstone by Brad Cox and Tom Love. Brad had read an article about Smalltalk, and deciced to write a pre-compiler that could use objects on top of the C programming language. Objective-C was adopted by NeXT Computer, the company started by Steve Jobs after he left Apple. Objective-C became the basis of the NextStep frameworks in the NeXT operating system. Jobs sold NeXT to [Apple](https://www.apple.com) to become the macOS X. It is also the basis of iOS, iPadOS, watchOS and tvOS.
